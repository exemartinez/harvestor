...
public class FollowersHandler {
	...
	/**
	 * Performs the following of the IDs passed as parameter, it doen't mind WHO
	 * is followed.
	 * 
	 * @param amount
	 *            - The amount of the given users to be followed.
	 * @param accounts
	 *            - a long array with all the accounts to follow.
	 */
